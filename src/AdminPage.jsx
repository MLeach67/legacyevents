            ...
            <table border="1" cellPadding="5" style={{ marginTop: '5px', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {(participants[event.id] || []).length === 0 ? (
                  <tr>
                    <td colSpan="7">No participants registered.</td>
                  </tr>
                ) : (
                    ...
                    <tr key={idx}>
                      ...
                      <td>
                        <input
                          ...
                          onChange={() => {
                            const updated = [...participants[event.id]];
                            updated[idx].paid = !updated[idx].paid;
                            setParticipants(prev => ({ ...prev, [event.id]: updated }));
                          }}
                        />
                      </td>
                      <td>
                    ...
                    <tr key={idx}>
                      ...
                      <td>
                        <input
                          ...
                          checked={p.paid || false}
                          onChange={() => {
                            const updated = [...waitingList[event.id]];
                            updated[idx].paid = !updated[idx].paid;
                            setWaitingList(prev => ({ ...prev, [event.id]: updated }));
                          }}
                        />
                      </td>
                      <td>
